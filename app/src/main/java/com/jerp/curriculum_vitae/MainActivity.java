...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.id_datos_personales) {
            // Handle the camera action
            fragmentManager.beginTransaction().replace(R.id.contenedor, new Datos_Personales()).commit();

        }else if (id == R.id.id_preparacion_academica) {
            fragmentManager.beginTransaction().replace(R.id.contenedor,new Preparacion_Academica()).commit();

        } else if (id == R.id.id_experiencia_laboral) {
            fragmentManager.beginTransaction().replace(R.id.contenedor,new Experiencia_Laboral()).commit();
